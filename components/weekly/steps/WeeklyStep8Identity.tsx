...
export function WeeklyStep8Identity({ review, weekStart, step }: Props) {
  return (
    <WeeklyLayout weekStart={weekStart} currentStep={step} totalSteps={11} stepLabel="Identity + zagrożenia"
      prevHref={`/weekly/${weekStart}/step/7`} nextHref={`/weekly/${weekStart}/step/9`}
